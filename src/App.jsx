...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[47%]">
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
         ...
         <div className="flex">
          ...
          <button onClick={handleAdd} disabled={todo.length <= 3} className='bg-violet-800 mx-2 rounded-full hover:bg-violet-950 disabled:bg-violet-500 p-4 py-2 text-sm text-white font-bold'>Save</button>
         </div>
        </div>
          ...
          {todos.map(item => {
            ...
            return (showFinished || !item.isCompleted) && <div key={item.id} className="todo flex md:1/2 my-3 justify-between">
              ...
              <div className="buttons flex h-full">
                <button onClick={(e) => handleEdit(e, item.id)} className='bg-violet-800 hover:bg-violet-950 p-2 py-1 text-sm text-white rounded-md mx-1 font-bold'><FaEdit /></button>
